(function(k, f, c, j, d, l, g) { /*! Jssor */
    ...
    var b = k.$Jssor$ = new function() {
        ...
        h.$SetStyleClip = function(d, a) {
            if (a) d.style.clip = "rect(" + c.round(a.$Top || a.$MoveY || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.$MoveX || 0) + "px)";
            else if (a !== g) {
        ...
        function w(f, l) {
            ...
            w = function(e, c) {
                ...
                if (c.$Transform)
                    if (d) yb(h.$CreateCallback(j, O, e, c));
                    else a(e, c)
            };
